    ...
    <div class="w-full">
      ...
      <div class="border-l border-green-500 w-full">
        ...
        >
          <div class="flex items-center">
            ...
            />
            <div class="text-gray-900 ml-1 font-semibold">Den</div>
          </div>
      ...
      >
        <div class="px-20 text-sm">
          <div class="flex w-[calc(100%-20vw)]">
            <div class="inline-block bg-white p-2 rounded-md my-1">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eaque ab
              voluptatibus consequatur impedit, nostrum maxime dolores ipsam
              cupiditate quod incidunt cumque ipsum, quas provident facilis,
              eligendi a nulla in repudiandae.
            </div>
          </div>
          <div
      ...
      <div class="w-[calc(100vw-420px)] p-2.5 z-10 bg-[#F0F0F0] fixed bottom-0">
        <div class="flex items-center justify-center">
          ...
          <input
            ...
            type="text"
          />
          <button type="ml-3 p-2 w-12 flex items-center justify-center">
